...
class ExperienciaController extends Controller
{
	...
	public function actionIndex()
	{
		...
		#Yii::import("zii.gustavo.Gustavo");
		#Yii::import("system.gustavo.Gustavo");
		#Yii::import("gus.Gustavo.inc");
		/*
		...
		*/
		...
		if(isset($_GET['mail']))
		{
			$this->layout="//layouts/main_email";
			...
			$mail=new PHPMailer();
			$mail->SetFrom("micorreo@gmail.com","Gustavo");
			$mail->Subject="Mi asunto";
			$mail->MsgHTML($text);
			$mail->AddAddress("destinatario@gmail.com","Gustavo");
			$mail->AddCC("copiando@gmail.com","Gustavo");
			$mail->AddBCC("copiandooculta@gmail.com","Gustavo");
			$mail->send();
