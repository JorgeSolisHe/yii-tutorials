...
class XActionMenu extends CWidget
{
	...
	protected function renderMenuItems($items)
	{
		...
		{
			if(isset($item['isString'])){
			
			$item['linkOptions']['class']=isset($item['linkOptions']['class']) && $item['linkOptions']['class']==''?'art-button':$item['linkOptions']['class'].=' art-button';
			$item['linkOptions']['style']=isset($item['linkOptions']['style']) && $item['linkOptions']['style']==''?'cursor:pointer':$item['linkOptions']['style'].=' ;cursor:pointer';
		
			  echo '  <span class="art-button-wrapper">';
			  echo '      <span class="art-button-l"> </span>';
			  echo '      <span class="art-button-r"> </span>';
			  echo  CHtml::link($item['label'],CHtml::normalizeUrl($item['url']),isset($item['linkOptions']) ? $item['linkOptions'] : array());
			  echo '  </span>';
